...
image: /img/posts/07-AI/00-claude-code-tips/claude-code.png
---
...
즉, CLAUDE.md는 LLM이 판단하여 특정 조건을 따를수도 따르지 않을 수도 있지만 `Hooks`는 강제한다. (쿠버네티스 스케줄링에서의 [Extension Points](../01-Container/02-Kubernetes/01-Learning/02-Scheduling/09-scheduler-profile.md#extension-points)를 떠올려보면 이해가 쉽다)
