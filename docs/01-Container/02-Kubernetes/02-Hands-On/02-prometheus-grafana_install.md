...
![prometheus-grafana-install1](assets/02-prometheus-grafana_install/prometheus-grafana-install1.jpg)
...
![prometheus-grafana-install2](assets/02-prometheus-grafana_install/prometheus-grafana-install2.jpg)
...
![prometheus-grafana-install3](assets/02-prometheus-grafana_install/prometheus-grafana-install3.jpg)

- `prometheus-server`를 보면 노드포트 타입으로 바뀐 것을 확인할 수 있다.

![prometheus-grafana-install4](assets/02-prometheus-grafana_install/prometheus-grafana-install4.jpg)
...
![prometheus-grafana-install5](assets/02-prometheus-grafana_install/prometheus-grafana-install5.jpg)
...
![prometheus-grafana-install6](assets/02-prometheus-grafana_install/prometheus-grafana-install6.jpg)
...
![prometheus-grafana-install7](assets/02-prometheus-grafana_install/prometheus-grafana-install7.jpg)

- 좌측 패널 > Connections > Data sources > Add data source
- Prometheus 선택

![prometheus-grafana-install8](assets/02-prometheus-grafana_install/prometheus-grafana-install8.jpg)

- Connection에 Prometheus URL 입력 후 Save & Test 선택해서 data source 생성

### Dashboard 만들기

![prometheus-grafana-install9](assets/02-prometheus-grafana_install/prometheus-grafana-install9.jpg)
...
![prometheus-grafana-install10](assets/02-prometheus-grafana_install/prometheus-grafana-install10.jpg)

- 원하는 대시보드의 ID 입력하고 Load (나는 1860을 사용하였다)

![prometheus-grafana-install11](assets/02-prometheus-grafana_install/prometheus-grafana-install11.jpg)
