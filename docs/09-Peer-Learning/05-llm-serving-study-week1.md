...
> 1. [Attention이란?](../07-AI/01-attention.md)
> 2. [Transformer란?](../07-AI/02-transformer.md)
...
> [Transformer란?](../07-AI/02-transformer.md) 글에서 Output Embedding의 Input을 생각해보자.
...
> 
> [Transformer란?](../07-AI/02-transformer.md) 이 글을 참고하면, 아래 내용의 이해가 쉽다.
...
- [Attention이란?](../07-AI/01-attention.md), [Transformer란?](../07-AI/02-transformer.md)
