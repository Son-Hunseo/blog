---
image: /img/posts/06-Dev/11-Spring/02-Legacy-Spring-Project-Setting/legacy-spring-setting1.jpg
...
![legacy-spring-setting1](assets/02-Legacy-Spring-Project-Setting/legacy-spring-setting1.jpg)

![legacy-spring-setting2](assets/02-Legacy-Spring-Project-Setting/legacy-spring-setting2.jpg)
...
![legacy-spring-setting3](assets/02-Legacy-Spring-Project-Setting/legacy-spring-setting3.jpg)
...
![legacy-spring-setting4](assets/02-Legacy-Spring-Project-Setting/legacy-spring-setting4.jpg)

- Project name을 입력한다.
- Target runtime -> New Runtime 선택

![legacy-spring-setting5](assets/02-Legacy-Spring-Project-Setting/legacy-spring-setting5.jpg)

- Tomcat을 검색하고 설치한 톰캣의 버전을 선택하고 Next를 누른다.

![legacy-spring-setting6](assets/02-Legacy-Spring-Project-Setting/legacy-spring-setting6.jpg)

- Browse를 선택하고 이전에 다운로드 받은 Tomcat이 있는 폴더를 선택한다.(안에 bin, lib 등이 있는 폴더)

![legacy-spring-setting7](assets/02-Legacy-Spring-Project-Setting/legacy-spring-setting7.jpg)
...
![legacy-spring-setting8](assets/02-Legacy-Spring-Project-Setting/legacy-spring-setting8.jpg)

- 프로젝트 우클릭 -> Run As ->Run On Server
- 프로젝트를 생성할 때 등록했던 런타임인 Tomcat을 선택 -> Finish

![legacy-spring-setting9](assets/02-Legacy-Spring-Project-Setting/legacy-spring-setting9.jpg)
