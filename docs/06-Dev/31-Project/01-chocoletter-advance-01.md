---
image: /img/posts/06-Dev/31-Project/01-chocoletter-advance-01/choco-legacy.png
sidebar_class_name: hidden-sidebar-item
date: 2026-01-21
title: "[초코레터 프로젝트 고도화 - 1] 쿠버네티스 환경으로 마이그레이션"
description: 단일 컨테이너 기반 아키텍처에서 쿠버네티스 환경으로 마이그레이션한 과정을 설명합니다. Self-healing, HPA 자동 스케일링, ArgoCD GitOps 배포, Gateway API를 통한 트래픽 관리 등 클라우드 네이티브 아키텍처의 이점을 구현한 방법을 다룹니다.
---
