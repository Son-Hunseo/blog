...
![prometheus-grafana-install1](prometheus-grafana-install1.jpg)
...
![prometheus-grafana-install2](prometheus-grafana-install2.jpg)
...
![prometheus-grafana-install3](prometheus-grafana-install3.jpg)

- `prometheus-server`를 보면 노드포트 타입으로 바뀐 것을 확인할 수 있다.

![prometheus-grafana-install4](prometheus-grafana-install4.jpg)
...
![prometheus-grafana-install5](prometheus-grafana-install5.jpg)
...
![prometheus-grafana-install6](prometheus-grafana-install6.jpg)
...
![prometheus-grafana-install7](prometheus-grafana-install7.jpg)

- 좌측 패널 > Connections > Data sources > Add data source
- Prometheus 선택

![prometheus-grafana-install8](prometheus-grafana-install8.jpg)

- Connection에 Prometheus URL 입력 후 Save & Test 선택해서 data source 생성

### Dashboard 만들기

![prometheus-grafana-install9](prometheus-grafana-install9.jpg)
...
![prometheus-grafana-install10](prometheus-grafana-install10.jpg)

- 원하는 대시보드의 ID 입력하고 Load (나는 1860을 사용하였다)

![prometheus-grafana-install11](prometheus-grafana-install11.jpg)
