...
| TCP      | **2379-2380** | etcd server client API  | **2379:** 클라이언트 통신용<br><br>**2380:** 다중 마스터 구성 시 etcd 노드 간 데이터 동기화용 |
...
- 쿠버네티스 파드(Pod) 간 통신을 위해 반드시 `1`로 설정되어 있어야 합니다.
	- 이에 대한 내용 정리 -> [IP 포워딩 활성화](../../../15-Network/01-Switching-Routing-Gateway###활성%20방법)
