---
image: /img/posts/08-HomeLab/01-SynologyNas/01-openvpn-to-wireguard/wireguard1.png
...
![wireguard1](assets/01-openvpn-to-wireguard/wireguard1.png)
...
![wireguard2](assets/01-openvpn-to-wireguard/wireguard2.png)

몇 분 기다리면 위 처럼 빌드를 완료했다는 메시지가 뜨고 빌드 산출물이 생긴다.

![wireguard3](assets/01-openvpn-to-wireguard/wireguard3.png)

### 설치하기

![wireguard4](assets/01-openvpn-to-wireguard/wireguard4.png)

- DSM에서 패키지 센터 > 수동 설치

![wireguard5](assets/01-openvpn-to-wireguard/wireguard5.png)

- 찾아보기를 누르고 아까 빌드된 산출물 spk 파일 선택 > 다음
  - debug버전 말고 기본 버전

![wireguard6](assets/01-openvpn-to-wireguard/wireguard6.png)

- 시놀로지에서 확인된 spk가 아니라 우리가 방금 빌드한 spk파일이기 때문에 뜨는 경고이다. 그냥 동의 누르면 된다.

![wireguard7](assets/01-openvpn-to-wireguard/wireguard7.png)
...
![wireguard8](assets/01-openvpn-to-wireguard/wireguard8.png)
...
![wireguard9](assets/01-openvpn-to-wireguard/wireguard9.png)

- DSM의 docker 공유폴더에 `wg-easy`라는 폴더를 만들어준다.

![wireguard10](assets/01-openvpn-to-wireguard/wireguard10.png)

- DSM 컨테이너 매니저 > 프로젝트 > 생성

![wireguard11](assets/01-openvpn-to-wireguard/wireguard11.png)
...
![wireguard12](assets/01-openvpn-to-wireguard/wireguard12.png)
...
![wireguard13](assets/01-openvpn-to-wireguard/wireguard13.png)
...
![wireguard14](assets/01-openvpn-to-wireguard/wireguard14.png)
