---
image: /img/posts/08-HomeLab/03-Hands-on/02-wol-linux/wol1.png
...
---
> [!info] WOL의 경우 pc가 한 번 이상 켰던 상태여야한다. 왜냐하면 WOL의 경우 S5상태(전원은 종료, 네트워크 카드에 대기 전력은 공급되는 상태)이어야 작동하는데, 한 번도 켜지지 않았던 pc의 경우 G3상태(모든 전력이 차단된 상태)이기 때문이다.
...
![wol1](assets/02-wol-linux/wol1.png)
...
> [!info] WOL 기능을 좀 더 편하게 사용하기 위해서는 휴대폰 앱을 사용할 수 있다. 다만, 외부에서 원격으로 사용해야할 때는 내부망에 접속 하기위한 VPN을 켠 상태에서 사용하면 된다.