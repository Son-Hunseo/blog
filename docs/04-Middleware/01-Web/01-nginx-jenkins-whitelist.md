---
image: /img/posts/04-Middleware/01-Web/01-nginx-jenkins-whitelist/whitelist1.png
...
![whitelist1](assets/01-nginx-jenkins-whitelist/whitelist1.png)

- 기존 주소로 접근하면 이렇게 차단되는 것을 알 수 있다.

![whitelist2](assets/01-nginx-jenkins-whitelist/whitelist2.png)
