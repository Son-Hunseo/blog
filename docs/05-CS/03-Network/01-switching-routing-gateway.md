---
image: /img/posts/05-CS/03-Network/01-switching-routing-gateway/switching1.png
...
> [!info] 가정에서 공유기에 랜선만 꽂으면 위와 같은 과정 없이 연결 되던데?
...
> [!info] 그냥 연결만 하면 되는거 아닌가? 라우팅 테이블 수동으로 작성해야하나?
